...
const reporte = () =>{
  if (cargando || (lista.length==0)) {
    if(cargando){
      ...
      return (
        <Card sx={{ minWidth:500,minHeight:400,marginBottom:5,marginRight:2, borderRadius: 5 }} elevation={8}>
        <Typography variant="h6" sx ={{marginTop:2, marginLeft:2,fontSize:'14px',fontWeight:'bold',fontFamily: 'Helvetica, Arial, sans-serif'}}>Cantidad de Reincidencia en Registros</Typography>
          <CardContent>
          <img src={NoElements} />
          </CardContent>
        </Card>
